...
#ifdef ONEPAGE_C61
  // OnePage physical front layout is [Back] [Left Right] [Confirm] (hardware_io.md
  // §4): Back/Confirm at the edges, Left/Right paired in the wide middle. Label
  // order comes from MappedInputManager::mapLabels (Back,Left,Right,Confirm).
  // 480px-wide portrait, 106px buttons.
  constexpr int onepageButtonPositions[] = {8, 122, 252, 366};
